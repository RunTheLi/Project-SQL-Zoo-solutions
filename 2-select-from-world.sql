...
-- Missing decimals
-- - For some version of SQL the division of an integer by an integer will be an integer.
-- - One way to prevent this is to divide by a floating point number such as 1000000.0.
