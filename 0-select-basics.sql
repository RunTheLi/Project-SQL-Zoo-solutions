...
-- The example below shows countries with an area of 250,000-300,000 sq.
-- km. Modify it to show the country and the area for countries with an area between 200,000 and 250,000.
